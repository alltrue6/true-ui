...
<template>
    <div>
        ...
        <div class="flex flex wrap mt-10">
            ...
            <button class="trueButton trueButton--info radius-min disable" disabled>Info</button>
            <button class="trueButton trueButton--warning radius-min disable" disabled>Warning</button>
