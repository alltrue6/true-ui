...
<template>
  <div class="content">
    ...
    <div class="flex flex-wrap mt-10">
      ...
      <button class="trueButton trueButton--info">Info</button>
    ...
    <div class="flex flex-wrap mt-10">
      ...
      <button class="trueButton trueButton--info radius-min">Info</button>
    ...
    <div class="flex flex-wrap mt-10">
      ...
      <button class="trueButton trueButton--info radius-max">Info</button>
    ...
    <!-- 禁用状态 -->
    <div class="flex flex-wrap mt-10">
      <button class="trueButton trueButton--default disable" disabled>
        Default
      </button>
      <button class="trueButton trueButton--primary disable" disabled>
        Primary
      </button>
      <button class="trueButton trueButton--success disable" disabled>
        Success
      </button>
      <button class="trueButton trueButton--info disable" disabled>Info</button>
      <button class="trueButton trueButton--warning disable" disabled>
        Warning
      </button>
      <button class="trueButton trueButton--danger disable" disabled>
        Danger
      </button>
    </div>
    <div class="flex flex-wrap mt-10">
      <button
        class="trueButton trueButton--default radius-min disable"
        disabled
      >
        Default
      </button>
      <button
        class="trueButton trueButton--primary radius-min disable"
        disabled
      >
        Primary
      </button>
      <button
        class="trueButton trueButton--success radius-min disable"
        disabled
      >
        Success
      </button>
      <button class="trueButton trueButton--info radius-min disable" disabled>
        Info
      </button>
      <button
        class="trueButton trueButton--warning radius-min disable"
        disabled
      >
        Warning
      </button>
      <button class="trueButton trueButton--danger radius-min disable" disabled>
        Danger
      </button>
    </div>
    <!-- 按钮组 -->
    <div class="flex flex-wrap mt-10">
      <button
        class="trueButton trueButton--default round_btn true--loading"
      ></button>
      <button class="trueButton trueButton--primary round_btn"></button>
      <button class="trueButton trueButton--success round_btn"></button>
      <button class="trueButton trueButton--info round_btn"></button>
